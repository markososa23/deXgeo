...
public class MapaDeCliente extends AppCompatActivity  implements OnMapReadyCallback {
   ...
   LocationCallback mLocationCallback = new LocationCallback() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapa_de_cliente);
        miToolbar.show(this, "VECINO", false);
        btnConexion = findViewById(R.id.btnConexion);
        mAuthProvider = new AuthProvider();
        mFusedLocation = LocationServices.getFusedLocationProviderClient(this);
        mMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapaCliente);
...
/*       mPlaces = Places.createClient(this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.accion_desautenticar) {
            ...
            Intent intent = new Intent(com.marcosoft.dexgeo.actividades.cliente.MapaDeCliente.this, MainActivity.class);
...
/*        mMap = googleMap;
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.ACCESS_FINE_LOCATION)) {
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ActivityCompat.requestPermissions(com.marcosoft.dexgeo.actividades.cliente.MapaDeCliente.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, LOCATION_REQUEST_CODE);
                            }
                        }).create()
                        .show();
            } else {
    ...
    void desautenticar() {
        desconectar();
        mAuthProvider.cerrarSesion();
        Intent intent = new Intent(MapaDeCliente.this, MainActivity.class);
        startActivity(intent);
        finish();
    }
    //Cuando se hace click en conectarse///
    public void clickConectarse2(View view) {
        if (mEstaConectado) {
            desconectar();
        }else{
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
